...
/**
 * Created by Jyoti on 3/30/2019.
 */

public class GetAggrepaySOAP {
    ...
    public GetAggrepaySOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
                                      String METHOD_NAME) {
    ...
    public String getSignature(long MemberId, String Amount, String TrackId) throws SocketException,SocketTimeoutException,Exception {
